;(() => {
  ...
  function addChangeAssigneeToButtonBar() {
    ...
    fieldChangeAssignee.style.top = '172px'
   ...
   * @param {*} element
   */
  function styleFixedDialog(element) {
    if (element) {
  ...
  function getDialogBackgroundFromLocalStorage() {
    const bgImage =
      ...
      'url("https://res.cloudinary.com/dmnntmjiv/image/upload/v1686102716/anime-girl_yvphev.jpg")'
